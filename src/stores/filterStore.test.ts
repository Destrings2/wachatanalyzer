...
describe('Filter Store', () => {
  ...
  describe('Sender Filter Management', () => {
    ...
    it('should set multiple senders at once', () => {
      const store = useFilterStore.getState()
      
      store.setSelectedSenders(['Alice', 'Bob', 'Charlie'])
      
      expect(useFilterStore.getState().selectedSenders).toEqual(['Alice', 'Bob', 'Charlie'])
    })
